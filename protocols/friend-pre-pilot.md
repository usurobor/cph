...
1. Give the participant the consent language in [Consent Template](../docs/ethics/consent-template.md).
...
6. Prepare the capture setup described in [Capture Setup](capture-setup.md).
...
Use the condition definitions in [Walking Conditions](walking-conditions.md).
...
Before processing the videos through OpenCap, complete [Blind Observation Memo](blind-observation-memo.md).
...
2. Export the outputs listed in [Outputs To Extract](../instruments/opencap/outputs-to-extract.md).
3. Segment gait cycles using the cycle unit defined in [Gait Cycle As Unit](../docs/concepts/gait-cycle-as-unit.md).
4. Extract features listed in [Features](../analysis/features.md).
5. Compare left and right sides using [Left Right Comparison](../analysis/left-right-comparison.md).
...
Use [Field Report 01 Friend Pre Pilot](../reports/field-report-01-friend-pre-pilot.md) after data collection.
