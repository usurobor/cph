...
> **⚠ Stream-A scaffolding caveat.** The decisions below are recorded against field-reports authored in Stream-A (engineering) cycles without the OpenCap data archive mounted in the dispatch container. Treat them as the *intended* gate states; they remain *provisional pending Stream-B validation* against real data. See [reports/field-report-01](reports/field-report-01-existing-data-zeroth-pilot.md), [-03](reports/field-report-03-construct-evaluation.md), and [-04](reports/field-report-04-falsification-evaluation.md) for the dev-work banners on each evidence surface.
